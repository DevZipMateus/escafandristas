...
const Hero = () => {
  return (
    <section 
      id="inicio" 
      className="pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-gradient-to-br from-white to-primary/5"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif text-gray-900 leading-tight">
              Ouse saber.
              <span className="block text-primary italic mt-2">Desenvolva seu intelecto.</span>
            </h1>
